...
(function () {
    ...
    function buildCustomUI() {
        ...
        btnKm.className = "cyber-btn-aio";
        btnKm.style.cssText = "flex: 1; padding: 8px 0; font-size: 11px; font-weight: bold; color: #fff; background: linear-gradient(45deg, #a855f7, #ec4899); border: none; border-radius: 4px; cursor: pointer; text-align: center; white-space: nowrap; box-shadow: 0 0 5px rgba(168, 85, 247, 0.5); text-transform: uppercase;";
        btnKm.innerText = "KM";
        btnKm.onclick = () => {
